...
public class Forgot extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("Main/Forgot.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Account acc: dao.getAccount()) {
            if (acc.getPhone().equals(phone)){
                ...
                ses.setAttribute("forgot", phone);
                url="Confirm_Phone";
                break;
            }
        }
        request.setAttribute("errPhone", "This phone doesn't have any account!");
